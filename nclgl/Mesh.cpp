...
//initialize attributes and generate VAO
Mesh::Mesh(void) {
	for (int i = 0; i < MAX_BUFFER; ++i)	{bufferObject[i] = 0;}
...
//delete arraies that we defined in construction 
Mesh ::~Mesh(void) {
...
//generate normals of each vertex
...
//generate tangents of each vertex
...
//generate tangents of a triangle
...
//draw the vertex here by triangles
void Mesh::Draw() {
...
//generate VBO with different condition
